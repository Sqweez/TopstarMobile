...
const RequestCallBackScreen = () => {
    ...
    const [title, setTitle] = useState('Закажите обратный звонок от нашего клуба');
    ...
    return (
        <SafeAreaView style={{
            ...
            <View style={styles.wrapper}>
                <Text style={styles.heading} className={'px-4'}>
                    { title }
                </Text>
            </View>
            <View style={styles.formWrapper} className="flex flex-col justify-center items-center w-full px-8 mt-4">
                ...
                <TouchableOpacity onPress={handleClose} className='mt-0'>
...
export default observer(RequestCallBackScreen);
